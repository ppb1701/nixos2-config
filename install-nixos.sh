...
echo ""
echo "═══════════════════════════════════════════════════════════════════════════"
echo "☁️  OPTIONAL: Configure Nextcloud (Private Cloud Storage)"
echo "═══════════════════════════════════════════════════════════════════════════"
echo ""
echo "Nextcloud is DISABLED by default and requires manual setup."
echo ""
...
echo ""
echo "  4. Uncomment Nextcloud sections in:"
echo "     - /etc/nixos/modules/services.nix (Nextcloud service)"
echo "     - /etc/nixos/modules/monitoring.nix (Nextcloud exporter)"
echo ""
...
echo "  Comment out the Nextcloud sections in services.nix and monitoring.nix"
echo ""
echo ""
echo ""
echo "═══════════════════════════════════════════════════════════════════════════"
echo "🔐 OPTIONAL: Configure Vaultwarden (Self-Hosted Password Manager)"
echo "═══════════════════════════════════════════════════════════════════════════"
echo ""
echo "Vaultwarden is DISABLED by default and requires manual setup."
echo ""
