...
echo ""
echo "═══════════════════════════════════════════════════════════════════════════"
echo "🖥️  CONFIGURE: VNC Remote Desktop Access"
echo "═══════════════════════════════════════════════════════════════════════════"
echo ""
echo "x11vnc + noVNC are ENABLED on this server. x11vnc needs a password file"
echo "before it will connect. Without it the service starts but refuses clients."
echo ""
echo "REQUIRED - Create the VNC password (one-time, survives rebuilds):"
echo "  x11vnc -storepasswd /etc/nixos/private/vncpasswd"
echo ""
echo "After setting the password, restart the service:"
echo "  sudo systemctl restart x11vnc"
echo ""
echo "Access remote desktop from any browser on the LAN:"
echo "  http://YOUR_IP:6080/vnc.html"
echo "  or http://vnc.home/vnc.html if you've added a DNS rewrite and Nginx"
echo "  virtual host for it (see modules/nginx-virtualhosts.nix)"
echo ""
echo ""
echo "═══════════════════════════════════════════════════════════════════════════"
...
echo "  Quota: 2000G (fruit:time machine max size)"
echo ""
